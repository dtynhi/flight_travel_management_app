...
const ReportMonth = () => {
  ...
  return (
    <div className='min-h-screen bg-gray-100 py-8 px-4 sm:px-6 lg:px-8'>
      <h1 className='text-4xl font-bold text-transparent bg-gradient-to-r from-purple-600 to-purple-400 bg-clip-text text-center mb-8'>BÁO CÁO THÁNG</h1>
      <div className='max-w-4xl mx-auto bg-white p-6 rounded-xl shadow-2xl'>
        <div className='flex justify-between mb-6'>
          ...
          />
          <Select value={month} onChange={setMonth} className='w-32 border border-purple-300 rounded-lg focus:border-purple-500' placeholder='Tháng'>
