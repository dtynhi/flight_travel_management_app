      ...
      <div className='flex flex-col md:flex-row max-w-6xl mx-auto mt-10 bg-white p-6 rounded shadow-md'>
        ...
        <div className='flex-1 pr-6'>
          ...
          <div className='mt-6 text-sm text-gray-600'>
            ...
            <p>
              Mỗi hành khách được mang theo một kiện hành lý xách tay và một vật dụng cá nhân miễn phí. Kiện hành lý ký gửi đầu tiên được miễn phí. Hành khách
              là thành viên chương trình khách hàng thân thiết được miễn phí kiện thứ hai. Xem chi tiết{' '}
